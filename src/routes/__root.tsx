...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Top-dollar cash for junk, damaged, and unwanted vehicles. Free towing across Michigan. Same-day pickup." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cash For Junk Cars in Michigan | Wayne Automotive Recyclers" },
      { name: "twitter:description", content: "Free towing. Same-day pickup. Top cash offers across Michigan." },
    ],
    links: [
